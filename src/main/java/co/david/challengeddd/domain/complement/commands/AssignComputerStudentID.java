...
public class AssignComputerStudentID extends Command {

  private final ComplementID complementID;
  private final ComputerID computerID;
  private final StudentID studentID;

  public AssignComputerStudentID(ComplementID complementID, ComputerID computerID, StudentID studentID) {
