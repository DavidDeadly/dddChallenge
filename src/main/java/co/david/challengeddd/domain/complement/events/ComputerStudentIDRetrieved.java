...
public class ComputerStudentIDRetrieved extends DomainEvent {

  private final ComputerID computerID;
  private final StudentID studentID;

  public ComputerStudentIDRetrieved(ComputerID computerID, StudentID studentID) {
    super("david.complement.ComputerStudentIDRetrieved");
